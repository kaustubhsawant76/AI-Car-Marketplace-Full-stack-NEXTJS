      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto">
            Advanced AI Car Search and test drive from thosands of vehicles.
          </p>
        </div>
        {/* SEARCH */}
        <HomeSearch/>
...
<section className="py-1" >
  <div className="container mx-auto px-4 ">
    <div className="flex justify-between items-center mb-8 mt-10">
      ...
      >Featured Cars</h2>
      <Button varaiant="ghost" className="flex items-center" asChild>
        <Link href="/cars">
        View All <ChevronRight className="ml-1 h-4 w-4"/></Link>
...
<p>
Book a test drive in minutes with flexible scheduling options
</p>
</div>
...
<div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent
 rounded-lg flex items-end  ">
  <h3 className="text-white text-xl font-bold pl-4 pb-2">{type.name}</h3></div>
...
<footer className="bg-blue-50 py-7 text-center"> 
Made with 💗 by Kaustubh Sawant</footer> 
